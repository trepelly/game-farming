...
export default {
  async fetch(request, env) {
    ...
    const allowed = ['msu.io', 'maplen.gg', 'msu.gg', 'api.msu.gg', 'api-static.msu.io', 'gamedatahub-static.msu.io', 'api-gateway.xangle.io', 'xangle.io', 'market-static.msu.io', 'p2p.binance.com', 'pricedancing.com', 'www.pricedancing.com', 'api.avax.network', 'avax.network'];
